#
# Makefile for the Gutenprint Printer Application
#
...
statedir	=	$(localstatedir)/lib/gutenprint-printer-app
spooldir	=	$(localstatedir)/spool/gutenprint-printer-app
serverbin	=	$(prefix)/lib/gutenprint-printer-app
